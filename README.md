...
<img width="1015" height="693" alt="image" src="https://github.com/user-attachments/assets/0d1b8a18-e612-466f-94e2-60d32469aa24" />
...
- **Bar Charts**: Displaying room types and neighbourhood group distributions.
...
```bash
   git clone https://github.com/anwshid03/Airbnb_Listings_EDA_Project.git
```
